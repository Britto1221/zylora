    ...
    complete = audit_snapshot(
        {
            ...
            "sections": [
                {"id": "hero", "type": "hero", "visible": True, "content": {"heading": "NEET coaching in Chennai", "body": "Focused learning " * 40}},
                {"id": "contact", "type": "lead-form", "visible": True, "content": {"heading": "Contact"}},
            ],
        },
        {
            "title": "NEET Coaching in Chennai | Northstar Academy",
            "description": "Prepare for NEET with structured coaching, experienced faculty, regular testing, and personal guidance in Chennai.",
