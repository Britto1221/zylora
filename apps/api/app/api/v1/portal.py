...
from app.db.models.entities import Domain, Lead, NotificationJob, SeoAudit, Site
...
def portal_summary(
    ...
    return {
        ...
        or 0,
        "totalLeads": db.scalar(select(func.count(Lead.id)).where(Lead.tenant_id == tenant_id))
        or 0,
        "messages": db.scalar(
